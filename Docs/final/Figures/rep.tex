\begin{figure}[H]
	\centering
		\begin{tikzpicture}[scale=1.4]
			\fill[gray!15,draw=black] (-0.5,-0.4) rectangle (3.5,2.6);
			...
			\end{scope}
		\end{tikzpicture}
	\caption[Example of a Representative Set]{Example of a Representative Set \question{Eu sei que falta mudar esta $:)$}}
	\label{fig:rep}
\end{figure}